			...
			return <div className='ui segment'>
				...
				<Segment attached='bottom'>
					<div className={'ui form ' + (this.props.loading ? 'loading' : '')}>
						<SelectField name='name' label='Name' options={this.props.items}
						             handleChange={this.props.handleSelectChange}/>
						<TextField name='description' label='Description' value={this.props.row.description}
						           handleChange={this.props.handleChange}/>
						<SelectField name='customer' label='Customer' options={this.props.customers}
						             handleChange={this.props.handleSelectChange}/>
					</div>
				</Segment>
