		...
		if (this.props.row) {
			return <div className='ui segment'>
				<Menu attached='top' tabular>
					...
					<Menu.Item name='security' active={this.state.activeItem === 'security'}
					           onClick={this.handleItemClick}/>
				</Menu>
				...
				<Segment attached='bottom'>
					<div className={'ui form ' + (this.props.loading ? 'loading' : '')}>
						...
						{this.state.activeItem === 'details' && <div>
							<Modal open={this.state.profilePictureModalOpen}
							       trigger={<Image onClick={this.openProfilePictureModal} className='profilePicture'
							                       src={this.getProfilePicture()} size='small' shape='circular'
							                       floated='left'/>}>
								<Modal.Header>Select a Photo</Modal.Header>
								<Modal.Content image>
									<Modal.Description>
										<Header>Upload new profile picture</Header>
										<input type='file' name='pic' ref='fileInput' accept='image/*'
							...
							<div className='two fields'>
								<TextField readonly={true} name='username' label='Username'
								           value={this.props.row.username}/>
								<TextField readonly={true} name='email' label='Email' value={this.props.row.email}/>
							</div>

							<div className='two fields'>
								<TextField name='firstName' label='First name' value={this.props.row.firstName}
								           handleChange={this.props.handleChange}/>
								<TextField name='lastName' label='Last name' value={this.props.row.lastName}
								           handleChange={this.props.handleChange}/>
							</div>
						</div>}

						{(this.state.activeItem === 'security' && !this.props.row.tfaEnabled) && <div className='field'>
							<Modal open={this.state.tfaModalOpen}
							       trigger={<Button onClick={this.openTfaModal}>Enable two factor
								...
								<Modal.Actions>
									...
									<Button color='green' inverted onClick={this.enableTfa}
									        disabled={!this.state.tfaConfirmed}>
						...
						{(this.state.activeItem === 'security' && this.props.row.tfaEnabled) && <div className='field'>
							<Modal open={this.state.disableTfaModalOpen}
							       trigger={<Button color='red' onClick={this.openDisableTfaModal}>Disable two factor
								       authentication</Button>} basic size='small'>
