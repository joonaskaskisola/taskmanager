...
use Taskio\Entity\Invoice;
use Taskio\Repository\InvoiceRepository;
...
class InvoiceController extends AbstractController
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $invoiceCustomer = $em->getRepository('Taskio:Customer')->findOneById($invoice->getCustomer());
    ...
    public function chooseTasksAction(Request $request, $invoiceId, $customerId)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $customer = $em->getRepository('Taskio:Customer')->findOneById($customerId);
        $invoice = $em->getRepository('Taskio:Invoice')->findOneById($invoiceId);
    ...
    public function showAction($id)
    {
        ...
        $invoice = $this->getDoctrine()
            ->getRepository('Taskio:Invoice')
            ->find($id);

        $invoiceRows = $this->getDoctrine()
            ->getRepository('Taskio:InvoiceRow')
            ->findBy(['invoice' => $id]);
