...
use Taskio\Entity\PrivateMessage;
use Taskio\Repository\PrivateMessageRepository;
...
class InboxController extends AbstractController
{
    ...
    {
        $messageRepository = $this->getDoctrine()->getRepository('Taskio:PrivateMessage');
    ...
    public function replyMessageAction(Request $request)
    {
        ...
        $repository = $this->getDoctrine()->getRepository('Taskio:PrivateMessage');
    ...
    public function postMessageAction(Request $request)
    {
        ...
        $userRepository = $this->getDoctrine()->getRepository('Taskio:User');
